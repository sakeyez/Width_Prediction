...
excel_result_path = save_excel_with_fallback(
    result_excel, os.path.join(data_output_dir, "DBN_预测结果汇总.xlsx")
)
...
df_test_result.to_csv(csv_result_path, index=False, encoding="utf-8-sig")
...
plt.tight_layout()
image_result_path = os.path.join(image_output_dir, "DBN_Pure_Prediction_Scatter.png")
